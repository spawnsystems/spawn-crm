...
export function TimeGrid({
  ...
  const gridCols = { gridTemplateColumns: `3rem repeat(${days.length}, 1fr)` }

  return (
    <div className="rounded-xl border border-border overflow-hidden bg-card">
      {/* Header + cuerpo comparten el MISMO contenedor con scroll, así el
          scrollbar afecta a ambos por igual y las columnas quedan alineadas. */}
      <div className="max-h-[72vh] overflow-y-auto">
        {/* Encabezado de días (sticky) */}
        <div
          className="grid sticky top-0 z-30 border-b border-border bg-card"
          style={gridCols}
        >
